            ...
            <Fade in timeout={500}>
                <Box sx={{ textAlign: 'center', p: 6 }}>
                    ...
                    <Typography variant="body1" color="text.secondary" paragraph>
                        Não foi possível gerar questões para o tema selecionado.
                    </Typography>
                    <Button
                        variant="contained"
                        onClick={onRestart}
            ...
            <Fade in timeout={500}>
                <Box sx={{ p: 4 }}>
                        ...
                        <CardContent>
                            <Stack direction="row" alignItems="center" spacing={2} mb={2}>
                                ...
                                <Box>
                                    ...
                                    <Chip
                                        label={`${student.subject} - ${student.theme}`}
                                        size="small"
                                        color="primary"
                                        variant="outlined"
                                        sx={{ mt: 1 }}
                    ...
                    <Box textAlign="center" mb={4}>
                        <Chip
                            icon={<Timer />}
                            label={`Tempo total: ${Math.floor(totalTime / 60)}min ${totalTime % 60}s`}
                            variant="outlined"
                            color="info"
                        />
                    </Box>
                                                ...
                                                sx={{
                                                    ...
                                                    bgcolor: selectedAnswer === null
                                                        ...
                                                        : isSelected
                                                            ...
                                                            : isCorrect ? 'success.main' : 'grey.400',
                                                    fontSize: '0.875rem',
                                                    fontWeight: 'bold'
                                                }}
                                            >
                    ...
                    <Fade in timeout={500}>
                        <Paper
                            sx={{
                                p: 2,
                                mb: 3,
                                bgcolor: selectedAnswer === question.correctAnswer
                                    ? 'success.50'
                                    : 'error.50',
                                border: 1,
